...
fontmake -m InriaSans-Roman.designspace -i -o ttf --output-dir ../fonts/ttf/
#fontmake -m IbarraRealNova-Italic.designspace -i -o ttf --output-dir ../fonts/ttf/

echo "Generating VFs"
fontmake -m InriaSans-Roman.designspace -o variable --output-path ../fonts/variable/InriaSans[wght].ttf
#fontmake -m InriaSans-Italic.designspace -o variable --output-path ../fonts/variable/InriaSans-Italic[wght].ttf
